...
MANUAL_FINDINGS = [
    ...
    },
    {
        "unitid": 131399,
        "manual_status": "partial_official_archive",
        "manual_best_root_url": "https://www.udc.edu/academics/registrar/course-catalog",
        "manual_root_type": "official_catalog_archive",
        "manual_coverage_start_year": 2008,
        "manual_coverage_end_year": 2022,
        "manual_search_evidence": "UDC Registrar course catalog page lists archived course catalogs including 2008-2011 and later catalog spans.",
        "programmatic_fix_needed": "Follow official registrar course-catalog pages before treating generated catalog roots as empty.",
        "next_pipeline_action": "retrieve_official_then_record_gap_limit",
    },
    {
        "unitid": 132903,
        "manual_status": "found_repository_archive",
        "manual_best_root_url": "https://stars.library.ucf.edu/ucfcatalogs/",
        "manual_root_type": "institutional_repository_bepress",
        "manual_coverage_start_year": 2000,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "UCF STARS library repository contains undergraduate catalog records, including 2000-2001 and 2001-2002.",
        "programmatic_fix_needed": "Use institutional repository catalog collections when current catalog pages do not expose older years.",
        "next_pipeline_action": "retrieve_panel_candidates",
    },
    {
        "unitid": 133951,
        "manual_status": "found_repository_archive",
        "manual_best_root_url": "https://digitalcommons.fiu.edu/catalogs/",
        "manual_root_type": "institutional_repository_bepress",
        "manual_coverage_start_year": 2000,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "FIU Digital Commons Course Catalogs collection contains undergraduate catalog records across the panel, including 2000-2001 and 2001-2002.",
        "programmatic_fix_needed": "Follow Digital Commons repository collections and pagination before declaring FIU gaps.",
        "next_pipeline_action": "retrieve_panel_candidates",
    },
    {
        "unitid": 141565,
        "manual_status": "found_official_archive",
        "manual_best_root_url": "https://hilo.hawaii.edu/catalog/back-issues",
        "manual_root_type": "official_catalog_archive",
        "manual_coverage_start_year": 1999,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "UH Hilo Back Issues page links PDF catalogs including 1999-2000, 2000-2001, and yearly catalogs through the panel.",
        "programmatic_fix_needed": "Follow official back-issues links from current catalog pages.",
        "next_pipeline_action": "retrieve_panel_candidates",
    },
    {
        "unitid": 141981,
        "manual_status": "partial_official_archive",
        "manual_best_root_url": "https://westoahu.hawaii.edu/academics/general-catalog/",
        "manual_root_type": "official_current_catalog_page",
        "manual_coverage_start_year": 2012,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "UH West Oahu current general catalog page and indexed PDF catalog records expose recent catalog years; older full archive root was not found in this pass.",
        "programmatic_fix_needed": "Search official PDF media paths for UH West Oahu before falling back to systemwide UH catalog pages.",
        "next_pipeline_action": "retrieve_official_then_record_gap_limit",
    },
    {
        "unitid": 142285,
        "manual_status": "found_digital_archive",
        "manual_best_root_url": "https://www.lib.uidaho.edu/digital/coursecatalogs/",
        "manual_root_type": "university_digital_archive",
        "manual_coverage_start_year": 2000,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "University of Idaho Library digital course catalog collection exposes catalog records including University of Idaho Catalog 2001.",
        "programmatic_fix_needed": "When a current catalog page points to a narrow policy page, search the institution library digital catalog collection.",
        "next_pipeline_action": "retrieve_panel_candidates",
    },
    {
        "unitid": 142559,
        "manual_status": "partial_official_archive",
        "manual_best_root_url": "https://csi.smartcatalogiq.com/",
        "manual_root_type": "official_catalog_archive",
        "manual_coverage_start_year": 2009,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "CSI SmartCatalog exposes archived catalogs beginning with 2009-2010; official PDF evidence also confirms 2006-2007.",
        "programmatic_fix_needed": "Use SmartCatalog roots and keep legacy/direct PDF evidence for years outside the online archive span.",
        "next_pipeline_action": "retrieve_official_then_record_gap_limit",
    },
    {
        "unitid": 145600,
        "manual_status": "found_official_archive",
        "manual_best_root_url": "https://catalog.uic.edu/ucat/archive-links/",
        "manual_root_type": "official_catalog_archive",
        "manual_coverage_start_year": 2003,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "UIC Archive and Links page lists archived undergraduate catalogs from 2003-2005 through the panel; older catalogs need separate archive follow-up.",
        "programmatic_fix_needed": "Parse archive-and-links pages and record early lower bounds when explicit.",
        "next_pipeline_action": "retrieve_official_then_record_gap_limit",
    },
    {
        "unitid": 145813,
        "manual_status": "found_official_and_library_archive",
        "manual_best_root_url": "https://library.illinoisstate.edu/collections/course-catalogs/2000-current/",
        "manual_root_type": "library_catalog_archive",
        "manual_coverage_start_year": 2000,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "Illinois State Milner Library course catalogs page lists complete course catalogs from 2000 to current, including annual undergraduate catalog links.",
        "programmatic_fix_needed": "Prefer official/library course-catalog archive pages over current catalog roots when they expose older PDF catalogs.",
        "next_pipeline_action": "retrieve_panel_candidates",
    },
    {
        "unitid": 155681,
        "manual_status": "partial_official_archive",
        "manual_best_root_url": "https://www.pittstate.edu/registrar/catalog/",
        "manual_root_type": "official_catalog_archive",
        "manual_coverage_start_year": 2011,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "Pittsburg State Registrar catalog page links archived catalogs from 2011-2012 forward in the current online collection.",
        "programmatic_fix_needed": "Record official archive lower bound for catalog pages that expose only later online catalogs.",
        "next_pipeline_action": "retrieve_official_then_record_gap_limit",
    },
    {
        "unitid": 156620,
        "manual_status": "found_official_and_repository_archive",
        "manual_best_root_url": "https://www.eku.edu/registrar/",
        "manual_root_type": "official_catalog_archive_plus_repository",
        "manual_coverage_start_year": 1999,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "EKU Registrar page lists 2012-2013 through current undergraduate catalogs and links the Encompass undergraduate catalog archive for earlier years.",
        "programmatic_fix_needed": "Follow official registrar pages plus linked repository archive pages for split catalog coverage.",
        "next_pipeline_action": "retrieve_official_then_repository_gaps",
    },
    {
        "unitid": 157289,
        "manual_status": "partial_official_archive",
        "manual_best_root_url": "https://catalog.louisville.edu/undergraduate/archive/",
        "manual_root_type": "official_undergraduate_catalog_archive",
        "manual_coverage_start_year": 2009,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "University of Louisville undergraduate catalog archive lists 2009-2010 forward and states earlier academic catalogs should be requested from the Registrar.",
        "programmatic_fix_needed": "Treat explicit pre-online Registrar-contact language as an archive lower-bound stop.",
        "next_pipeline_action": "retrieve_official_then_record_gap_limit",
    },
    {
        "unitid": 157386,
        "manual_status": "found_repository_archive",
        "manual_best_root_url": "https://scholarworks.moreheadstate.edu/msu_catalogs/",
        "manual_root_type": "institutional_repository_bepress",
        "manual_coverage_start_year": 2002,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "Morehead State ScholarWorks catalog archive contains undergraduate catalog records beginning with 2002-2003 and continuing through later years.",
        "programmatic_fix_needed": "Follow repository pagination and use explicit lower-bound stops for years before first visible catalog.",
        "next_pipeline_action": "retrieve_official_then_record_gap_limit",
    },
    {
        "unitid": 159373,
        "manual_status": "scope_dead_end_specialized_health_sciences",
        "manual_best_root_url": "https://www.lsuhsc.edu/library/databases/catalog.aspx",
        "manual_root_type": "specialized_health_sciences_catalog_archive",
        "manual_coverage_start_year": 0,
        "manual_coverage_end_year": 0,
        "manual_search_evidence": "LSUHSC library catalog database page documents Academic Catalog/Bulletin access from 1931-present for health sciences schools; this is specialized professional/health-sciences scope, not a standard undergraduate catalog.",
        "programmatic_fix_needed": "Add scope handling for health-sciences centers so catalog evidence is kept but not confused with university-wide undergraduate archives.",
        "next_pipeline_action": "scope_review_or_specialized_catalog_retrieval",
    },
    {
        "unitid": 159382,
        "manual_status": "partial_official_archive",
        "manual_best_root_url": "https://www.lsua.edu/academics/registrar/catalog/",
        "manual_root_type": "official_catalog_archive",
        "manual_coverage_start_year": 2004,
        "manual_coverage_end_year": 2018,
        "manual_search_evidence": "LSUA Registrar catalog page states digital catalogs are provided for AY 2004-2005 through AY 2018-2019 and prior print catalogs are in the Bolton Library archive room.",
        "programmatic_fix_needed": "Treat explicit print-archive/contact language as lower/upper bounds for the current online workflow.",
        "next_pipeline_action": "retrieve_official_then_record_gap_limit",
    },
    {
        "unitid": 159717,
        "manual_status": "partial_official_archive",
        "manual_best_root_url": "https://catalog.mcneese.edu/",
        "manual_root_type": "official_catalog_archive",
        "manual_coverage_start_year": 2008,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "McNeese catalog policy states online archived catalogs are available from 2008-2009 to present and earlier hard-copy catalogs are housed in Frazar Memorial Library archives.",
        "programmatic_fix_needed": "Record explicit online archive lower bounds and library hard-copy referrals.",
        "next_pipeline_action": "retrieve_official_then_record_gap_limit",
    },
    {
        "unitid": 161244,
        "manual_status": "partial_official_archive",
        "manual_best_root_url": "https://machias.edu/academics/course-catalog/",
        "manual_root_type": "official_catalog_archive",
        "manual_coverage_start_year": 2010,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "UMaine Machias course catalog page lists archived catalogs from 2010-2012 forward.",
        "programmatic_fix_needed": "Record official archive lower bound when the page visibly begins after the panel start.",
        "next_pipeline_action": "retrieve_official_then_record_gap_limit",
    },
    {
        "unitid": 161341,
        "manual_status": "partial_official_archive",
        "manual_best_root_url": "https://www.umpi.edu/academics/archived-catalogs/",
        "manual_root_type": "official_catalog_archive",
        "manual_coverage_start_year": 2008,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "UMPI archived academic catalogs page describes catalog access from 2008 to 2020 and links annual course catalog PDFs.",
        "programmatic_fix_needed": "Prefer official archived-catalogs page over generated current catalog root.",
        "next_pipeline_action": "retrieve_official_then_record_gap_limit",
    },
    {
        "unitid": 162584,
        "manual_status": "found_official_archive",
        "manual_best_root_url": "https://www.frostburg.edu/academics/catalog/undergraduate-catalog-archives.php",
        "manual_root_type": "official_undergraduate_catalog_archive",
        "manual_coverage_start_year": 1999,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "Frostburg undergraduate catalog archive lists two-year undergraduate catalogs from 1999-2001 through 2020-2021.",
        "programmatic_fix_needed": "Use the official undergraduate catalog archive page rather than stopping at current catalog roots.",
        "next_pipeline_action": "retrieve_panel_candidates",
    },
    {
        "unitid": 163286,
        "manual_status": "found_official_archive",
        "manual_best_root_url": "https://catalogundergraduate.umd.edu/pastcatalogs.html",
        "manual_root_type": "official_undergraduate_catalog_archive",
        "manual_coverage_start_year": 2000,
        "manual_coverage_end_year": 2020,
        "manual_search_evidence": "University of Maryland undergraduate catalog site exposes past catalog directories including 2001-2002; current catalog site covers later undergraduate catalogs.",
        "programmatic_fix_needed": "Use official UMD past-catalog directories before relying on Internet Archive item pages.",
        "next_pipeline_action": "retrieve_panel_candidates",
    },
]
